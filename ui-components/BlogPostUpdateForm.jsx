      ...
      const record = slugProp
        ? (
            await client.graphql({
              query: getBlogPost.replaceAll("__typename", ""),
              variables: { slug: slugProp },
            })
          )?.data?.getBlogPost
        : blogPostModelProp;
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateBlogPost.replaceAll("__typename", ""),
            variables: {
              input: {
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(slugProp || blogPostModelProp)}
